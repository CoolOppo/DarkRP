...
TEAM_CITIZEN = DarkRP.createJob("Citizen", {
    ...
    model = {
        "models/echo/raptor/ark_raptor_new.mdl",
        "models/player/soigebib.mdl",
        "models/models/monogarovka/egorka.mdl",
        "models/player/fortnite/characters/ninja/ninja_pm.mdl",
        "models/fort/nite/jonesy.mdl",
        "models/ianmata1998/cryoffear/simon_chair.mdl",
        "models/boyohboy/umokay/umokay.mdl",
        "models/player/jermrat/jermrat.mdl",
        "models/player/funnyrat/rat.mdl"
    },
    description = [[ ]],
    weapons = {},
    command = "citizen",
...
TEAM_TERRORIST = DarkRP.createJob("Terrorist", {
    ...
    PlayerDeath = function(ply, weapon, killer)
        ...
        ply:Freeze(true)
        timer.Simple( 30, function() ply:Freeze(false) end )
...
TEAM_GANG = DarkRP.createJob("Gangster", {
    ...
    model = {
        ...
        "models/player/nosaczt37/nosacz.mdl"},
...
TEAM_GUN = DarkRP.createJob("Gun Dealer", {
    ...
    model = {"models/kuma96/joshuagraham/joshuagraham_pm.mdl", "models/patrickbateman/playermodels/patrickbateman.mdl"},
...
TEAM_POLICE = DarkRP.createJob("Police Officer", {
    ...
    model = {"models/gonzo/monkcop/monkcop.mdl", "models/player/neckbeard.mdl", "models/eradium/rexouium.mdl"},
    description = [[The protector of every citizen that lives in the city.
        You have the power to arrest criminals and protect innocents.
        Hit a player with your arrest baton to put them in jail.
        Bash a player with a stunstick and they may learn to obey the law.
        Type /wanted <name> to alert the public to the presence of a criminal.]],
    weapons = {"arrest_stick", "unarrest_stick", "robotnik_mw2_usp", "stunstick", "lockpick", "bkeypads_cracker", "zwf_sniffer"},
    command = "cp",
    max = 10,
...
TEAM_CHIEF = DarkRP.createJob("Police Chief", {
    ...
    model = {"models/player/falloutnewvegas/ncr/ncr_ranger_playermodel.mdl", "models/ninja/jc_denton.mdl", "models/hellinspector/simpsons/wiggum_m.mdl"},
    ...
    weapons = {"arrest_stick", "unarrest_stick", "robotnik_mw2_g18", "stunstick", "lockpick", "bkeypads_cracker", "zwf_sniffer", "tfa_csgo_flash", "tfa_csgo_smoke", "tfa_csgo_frag", "tfa_csgo_item_defuser"},
    command = "chief",
    max = 1,
